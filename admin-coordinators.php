              ...
              <div class="tab-content"> 
                ...
                <div role="tabpanel" class="tab-pane fade in active" id="about-me">
                   <div style="padding: 15px 20px; color: grey">
                    <a href="admin.php" style="font-weight: bold; color: grey">Dashboard</a> &nbsp;/ &nbsp;Coordinators
                  </div>
                      ...
                      while($row = mysqli_fetch_assoc($result)){
                        ...
                        <div class="col-md-6" style="padding: 5px">
                          ...
                          <div class="col-md-9">
                            ...
                            <a href="deletec.php?CoordinatorID=<?=$row['CoordinatorID']?>" class="btn btn-danger btn-sm pull-right" name="delete">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="admin-addc.php" method="POST" >
                        <div class="row">
                            <div class="col-md-6 ">
