         ...
         <div class="col-md-3" style="">
           ...
           <div class="col-md-12" style="padding: 0px">
            <div style="padding: 30px; padding-bottom: 0px">
                <img src="images/<?=$data['photo']?>" class="img-responsive" alt="" style="border-radius: 100%; width: 100px; height: 100px; margin-top: 20px">                
            </div>
              </div>
           <div class="col-md-12">
            <div style="padding: 30px; padding-top: 10px; padding-bottom: 0px">
             <h5 style="text-transform: none; margin: 0px; padding: 5px 0px;line-height: 1.5">
               ...
               <?=$data['firstname']?> <?=$data['lastname']?>
                          ...
                          <p style="font-size: 16px"> 10001</p>
          ...
          <nav> 
                  ...
                  <ul class=" nav nav-pills nav-stacked">
                    <li style="margin-bottom: 10px" role="presentation"><a style="" href="#about-me" aria-controls="about-me" role="tab" data-toggle="tab"> My Account &nbsp; &nbsp;<i class="fa fa-id-badge pull-right" style="opacity: .7"></i></a></li>
              ...
              <div class="tab-content"> 
                ...
                <div role="tabpanel" class="tab-pane fade in active" id="about-me">
                  <div style="padding: 15px 20px; color: grey">
                    <a href="coordinator-member.php" style="font-weight: bold; color: grey">Dashboard</a> &nbsp;/ &nbsp;Habu's Profile
                  </div>
                  <div class="inside-sec"> 
                    ...
                    <div class="col-md-12">                      
                      <div class="col-md-1 col-xs-3" style="padding: 6px">
                      ...
                      <div class="col-md-3 col-xs-12">
                        <h6 class="pull-right visible-md visible-lg" style="text-transform: none;line-height: 1.5; font-weight: 500; margin-bottom: 2px; margin-top: 3px">
                          <span style="font-weight: normal;">
                          Total Earnings:
                          </span>
                        <br>
                        <span style="color: #10bb10">
                          $300.00                          
                        </span>
                        </h6>
                        <h6 class="visible-sm visible-xs" style="text-transform: none;line-height: 1.5; font-weight: 500; margin-bottom: 2px; margin-top: 8px">
                          <span style="font-weight: normal;">
                          Total Earnings:
                          </span> &nbsp;
                        <span style="color: #10bb10">
                    ...
                    <br>
                    <hr style="margin: 0px; border: 1px solid #ddd; padding: 0px">
                     <h5 class="tittle" style="padding: 0px 10px 15px 20px;font-weight: normal; text-transform: none; line-height: 1.2">
                      
                      <div style="width: 100%; height: 10px"></div>
                     Habu's Services Provided History
                    </h5>
                  </div>
                  <br>
                  <br>
                    ...
                    <div style="width: 100%; padding: 50px 20px; background: #fff; margin-bottom: 20px">
                      ...
                      <h5 style="font-weight: normal; text-transform: none;">
                        Habu has not provided any services yet
                      </h5>
                      </center>
                    </div>
                        ...
                        <div class="contact-right"> 
                          ...
                          <form role="form" id="contact_form_1" class="contact-form" method="post" onSubmit="return false">
                            <ul class="row">
                              ...
                              <li>
                                <label>
                                  <input type="text" class="form-control" name="name" id="name_1" placeholder="NAME" value="<?=$data['firstname']?>">
                                </label>
                              </li>
                            </div>
                              <div class="col-xs-6">
