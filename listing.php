                      ...
                      <div class="col-md-6">
                        <div class="utility-social">
                          <ul class="social-inner custom-list">
                            <li style="float:left;margin:4px;"><a href="#" class="facebook"><i class="fa fa-facebook"></i></a></li>
                            <li style="float:left;margin:4px;"><a href="#" class="google-plus"><i class="fa fa-google-plus"></i></a></li>
                            <li style="float:left;margin:4px;"><a href="#" class="twitter"><i class="fa fa-twitter"></i></a></li>
                            <li style="float:left;margin:4px;"><a href="#" class="linkedin"><i class="fa fa-linkedin"></i></a></li>
                            <li style="float:left;margin:4px;"><a href="#" class="pinterest"><i class="fa fa-pinterest"></i></a></li>
                            <li style="float:left;margin:4px;"><a href="#" class="dribbble"><i class="fa fa-dribbble"></i></a></li>
                          </ul>
                        </div>
                      </div>
                            ...
                            <div class="listing-box col-lg-3 col-md-3 col-sm-3">
                              ...
                              <div class="gray-bottom">
                                ...
                                <ul class="company-tags custom-list clearfix">
                                  <li><a href="#"><?php echo $data["address"]; ?></a></li>
                                </ul>
                              </div>
                            </div>
