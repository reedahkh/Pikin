...
--
-- Host: localhost:8889
-- Generation Time: Dec 26, 2017 at 08:42 PM
...
INSERT INTO `educators` (`EducatorID`, `firstname`, `lastname`, `email`, `phonenumber`, `password`, `hashkey`, `postcode`, `suburb`, `coordinator`, `rating`, `avatar`, `active`, `address`, `numkids`, `ageofkids`, `typeofservice`, `servicehours`) VALUES
(1, 'Habu', 'Mohammed', 'moh@yahoo.com', '+2348038471835', 'mohash', '', 5006, 'North Adelaide, SA', 'Mr Abdul', 1, 'default.jpg', 1, '', '', '', '', ''),
(2, 'Zee', 'Musa', 'zee@yahoo.com', '+2345968735467', 'zee', '', 5006, 'North Adelaide, SA', 'Mr Joshua', 2, 'default.jpg', 0, '', '', '', '', ''),
(3, 'Ree', 'Akin', 'ree@yahoo.com', '+2345968735467', 'ree', '', 5950, 'Adelaide Airport, SA', 'Mr Joshua', 3, 'default.jpg', 0, '', '', '', '', ''),
(4, 'Habu', 'Hashidu', 'habu@yahoo.com', '+2348097654372', 'habu', '', 5950, 'Adelaide Airport, SA', 'Mr Yusuf', 3, 'default.jpg', 0, '', '', '', '', ''),
(5, 'Kauna', 'Magaji', 'kauna@yahoo.com', '+2348075937563', 'kauna', '', 4703, 'Adelaide Park, Old', 'Mr Joshua', 3, 'default.jpg', 0, '', '', '', '', ''),
(6, 'Mary', 'Joseph', 'mary@yahoo.com', '+2345968735467', 'mary', '', 4703, 'Adelaide Park Old', 'Mr John', 3, 'default.jpg', 0, '', '', '', '', ''),
(7, 'Isabelle', 'Joseph', 'isabel@gmail.com', '+2345968735465', 'isabel', '', 4211, 'Gaven', 'Mr John', 4, 'default.jpg', 0, '', '', '', '', ''),
(8, 'Lucy', 'Lui', 'lucy@yahoo.com', '+2348038471833', 'lucy', '', 4211, 'Gaven', 'Mr Philips', 4, 'default.jpg', 0, '', '', '', '', ''),
(9, 'Nora', 'Roberts', 'nora@yahoo.com', '+234596873086', 'nora', '', 3814, 'Garfield, Vic', 'Mr Sam', 3, 'default.jpg', 0, '', '', '', '', ''),
(10, 'Farida', 'Kabir', 'fareedakabeer@icloud.com', '', 'SHA1 (ff)', '7e7757b1e12abcb736ab9a754ffb617a', 0, '', '', 0, 'default.jpg', 0, '', '', '', '', ''),
(11, 'Amira', 'Kabir', 'amira@gmail.com', '', 'SHA1 (a)', '202cb962ac59075b964b07152d234b70', 0, '', '', 0, 'default.jpg', 0, '', '', '', '', ''),
(12, 'tt', 'tt', 't@yahoo.com', '', 'SHA1 (t)', '1ecfb463472ec9115b10c292ef8bc986', 0, '', '', 0, 'default.jpg', 0, '', '', '', '', '');
...
INSERT INTO `parents` (`ParentID`, `image`, `firstname`, `lastname`, `email`, `age`, `password`, `hashkey`, `paymentmethod`, `phonenumber`, `homeaddress`, `homesuburb`, `homepostcode`, `officeaddress`, `officesuburb`, `officepostcode`, `numkids`, `ageofkids`, `typeofservice`, `servicehours`, `active`) VALUES
...
(14, '', 'Farida', 'Kabir', 'fareedakabeer@gmail.com', 0, 'SHA1 (f)', '17c276c8e723eb46aef576537e9d56d0', '', '', '', '', '', '', '', '', 0, 0, '', '', 0);
...
--
ALTER TABLE `booking`
  MODIFY `BookingID` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `parents`
  MODIFY `ParentID` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;