<?php
  ...
  if (!isset($AdminID)) {
    ...
    $query = "SELECT * from parents where active = '1' ";
              ...
              <div class="tab-content"> 
                ...
                <div role="tabpanel" class="tab-pane fade in active" id="about-me">
                   <div style="padding: 15px 20px; color: grey">
                    <a href="admin.php" style="font-weight: bold; color: grey">Dashboard</a> &nbsp;/ &nbsp;Parents
                  </div>
                    ...
                    <div style="width: 100%; padding: 50px 20px; background: #fff; margin-bottom: 20px">
                      ...
                      while($row = mysqli_fetch_assoc($result)){
                        ...
                        <div class="col-md-6" style="padding: 5px">
                          ...
                          <img src="images/<?=$row['image']?>" width="100%" style="border-radius: 5px">        
                          </div>
                          <div class="col-md-9">
                            ...
                            <span style="font-size: 16px;">
                              <i class="fa fa-map-marker" style="color: #ccc"></i> &nbsp;<?=$row['homesuburb']?>
                            </span>
                            <br>

                            <a href="deletep.php?ParentID=<?=$row['ParentID']?>" class="btn btn-danger btn-sm pull-right" name="delete">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="admin-addp.php" method="POST" >
                        <div class="row">
                            <div class="col-md-6 ">
      ...
      <button type="submit" name="submit" class="btn btn-primary btn-block">
        Register
                         ...
                         <font color="red"> <?php 
                            $reasons = array("success" => "You have successfully registered", "email" => "Email already exists"); 
                            if ($_GET["RegisterSuccessful"]) {
                              echo $reasons[$_GET["reason"]];
                            }

                            elseif ($_GET["RegisterFailed"]) {
                              echo $reasons[$_GET["reason"]];
                            }
